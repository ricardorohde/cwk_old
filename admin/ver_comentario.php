...
<div id="conteudo">
<div class="texto">
<h1 align="center">Dados Pessoais</h1></div>
<br />
<div align="center">
    <?php
...
<?php
$id = $_GET['id'];
	$sql = mysql_query("SELECT * FROM responder WHERE id = '$id'") or die(mysql_error());
...
<table width="608" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td align="center" class="tabela">Resposta</td>
    <td align="center" class="bg"><?php echo $dica;?></td>
  </tr>
</table>
<a href="?excluir=<?php echo $id;?>" class="excluir"><br />
</a>
<a href="lista_recados.php" class="edit"><br /><br />Voltar</a>
