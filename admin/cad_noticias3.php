...
<?php if(isset($_POST['cad'])){
    ...
    $inserir = mysql_query("INSERT INTO noticias(ideia, conteudo, img_principal, data, palavra_chave, cliques) VALUES ('$ideia', '$conteudo', '$capa_name', '$data', '$palavra', '1')") or die(mysql_error());
	 if($inserir = 0){
    ...
    $insere = mysql_query("INSERT INTO noticia_categorias(id_noticia, id_cat) VALUES ('$id_not', '$opcoes')") or die(mysql_error());
	}
	 }
?>
