...
<div id="conteudo">
<div class="texto">
<h1 align="center">Listagem de respostas</h1></div>
<br />
<div align="center">
<table width="650" border="0" align="center">
  <tr class="tabela">
	...
	?>
    <?php
	$sql = mysql_query("SELECT * FROM responder ORDER BY id DESC") or die(mysql_error());
  ...
  <tr>
    ...
    <td width="84" align="center"><a href="ver_resposta.php?id=<?php echo $id;?>" class="edit">Visualizar</a></td>
