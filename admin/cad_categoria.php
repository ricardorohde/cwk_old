...
<div id="conteudo">
<div class="texto">
  <h1 align="center">Cadastrar Canal</h1></div>
<?php if(isset($_POST['cad'])){
	$cat = $_POST['categoria'];
    $inserir = mysql_query("INSERT INTO categorias(nome) VALUES ('$cat')") or die(mysql_error());
	if($inserir = 0){
...
<p align="center"><br />
Novo Canal:</p>
<div align="center"><input type="text" name="categoria" /></div>
</label>
<br />
...
<table width="650" border="0" align="center">
  <tr class="tabela">
    <td align="center">Canais</td>
    <td colspan="2" align="center">Ações</td>
  </tr>
  <?php
	if(isset($_GET['excluir'])){
		$var = $_GET['excluir'];
		$del = mysql_query("DELETE FROM categorias WHERE id = '$var'") or die(mysql_error());
		if($del){
	...
	?>
  <?php
	$sql = mysql_query("SELECT * FROM categorias ORDER BY id DESC") or die(mysql_error());
	while($res = mysql_fetch_array($sql)){
		$id = $res['id'];
		$categoria = $res['nome'];
	?>
  <tr>
    <td align="center" class="bg"><?php echo $categoria;?></td>
