...
<table width="650" border="0" align="center">
  <tr class="tabela">
	...
	?>
    <?php
	$sql = mysql_query("SELECT * FROM enviar_dica ORDER BY id DESC") or die(mysql_error());
  ...
  <tr>
    ...
    <td width="84" align="center"><a href="ver_dica.php?id=<?php echo $id;?>" class="edit">Visualizar</a></td>
