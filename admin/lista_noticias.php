...
<table width="650" border="0" align="center">
  <tr class="tabela">
    <td align="center">Idéia</td>
    <td colspan="2" align="center">Ações</td>
    </tr>
    <?php
	if(isset($_GET['excluir'])){
		$var = $_GET['excluir'];
		$del = mysql_query("DELETE FROM noticias WHERE id = '$var'") or die(mysql_error());
		if($del){
	...
	?>
    <?php
	$sql = mysql_query("SELECT * FROM noticias ORDER BY id DESC") or die(mysql_error());
  ...
  <tr>
    ...
    <td width="84" align="center"><a href="edita_noticia.php?id=<?php echo $id;?>" class="edit">Editar</a></td>
