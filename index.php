			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="logar.php" method="post">
					<span class="login100-form-title p-b-43">
						Sistema de Agendamento Coworking Linhares
					</span>
					
					
					<div class="wrap-input100" data-validate = "CNPJ/CPF INVÁLIDO">
						<input class="input100" type="text" name="login">
						<span class="focus-input100"></span>
						<span class="label-input100">CNPJ/CPF (Somente os números)</span>
					</div>
