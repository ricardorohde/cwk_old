		    ...
		    <div class="sidebar-wrapper">
		        ...
		        <ul class="nav">
				   ...
				   <?php
					...
					?>
					<li><p style="margin: 20px auto 20px 65px">Serviços Contratados:</p></li>
					<?php
						}
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                switch (@$_REQUEST['page']) {
                                                    ...
                                                    case 'listar-usuario':
                                                        ...
                                                        break;
													case 'agenda_tpc':
														echo '<iframe src="agenda_tpc/index.php" class="col-md-11" style="height:700px" frameborder="0"></iframe>';
														break;
                                                    case 'salvar-usuario':
