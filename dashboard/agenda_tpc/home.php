...
$result_events = "SELECT id, id_usuario, title, cli_cli, color, start, end, sala FROM events";

//Condição para pegar apenas a data do dia.
// WHERE date_format(str_to_date(start, '%Y-%m-%d %H:%i:%s'), '%Y-%m-%d') = CURRENT_DATE()";
...
<html lang="pt-br">
	<head>
		...
		<script>
			...
			$(document).ready(function() {
				$('#calendar').fullCalendar({
					...
					eventClick: function(event) {
						...
						$('#visualizar #cli_cli').val(event.cli_cli);
												$('#visualizar #sala').text(event.sala);
						$('#visualizar #sala').val(event.sala);
				...
				//INICIO CALENDARIO 2 SALA ATEND COMP
				
				
				//FIM CALENDARIO 2 SALA ATEND COMP
	...
	<body>
		...
		<!--<div class="container">
			...
			<h2 style="text-align: center;">AGENDAMENTOS DO DIA</h2><br><br>
...
-->
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">Cliente</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="cliente" id="cliente" onKeyPress="DataHora(event, this)">
									</div>
								</div>
								<div class="form-group">
								...
								<input type="hidden" name="sala" id="sala" value="auditorio">
							</form>
