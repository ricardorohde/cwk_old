...
$result_events = "SELECT id, id_usuario, title, cli_cli, color, start, end, sala FROM events WHERE sala='atend_comp'";
...
-->
								...
								<input type="hidden" name="sala" id="sala" value="atend_comp">
							</form>
