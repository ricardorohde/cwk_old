...
$result_events = "SELECT id, id_usuario, title, cli_cli, color, start, end, sala FROM events WHERE sala='multiuso'";
							...
							<form class="form-horizontal" method="POST" action="proc_edit_evento.php">
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="hidden" name="color" value="#006400">
...
-->
								...
								<input type="hidden" name="sala" id="sala" value="multiuso">
							</form>
