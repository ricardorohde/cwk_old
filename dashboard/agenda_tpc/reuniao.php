...
$result_events = "SELECT id, id_usuario, title, cli_cli, color, start, end, sala FROM events WHERE sala='reuniao'";
							...
							<form class="form-horizontal" method="POST" action="proc_edit_evento.php">
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="hidden" name="color" value="#FFD700">
...
-->
								...
								<input type="hidden" name="sala" id="sala" value="reuniao">
							</form>
