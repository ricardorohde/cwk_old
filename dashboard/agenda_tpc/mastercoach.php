...
$result_events = "SELECT id, id_usuario, title, cli_cli, color, start, end, sala FROM events WHERE sala='mastercoach'";
...
-->
								...
								<input type="hidden" name="sala" id="sala" value="mastercoach">
							</form>
