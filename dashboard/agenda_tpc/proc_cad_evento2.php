...
if (!empty($id_usuario) && !empty($title) && !empty($color) && !empty($start) && !empty($end)) {
    ...
    $result_events = "INSERT INTO events (id_usuario, title, color, start, end, status, data_cad) VALUES ('$id_usuario','$title', '$color', '$start_sem_barra', '$end_sem_barra', 'Agendado', '$data_atual')";
